...
class Decoder(nn.Module):
    ...
    def forward(self, ctx, ctx_lengths, tgt, tgt_lengths, hid, topic_embed, topics, grammar):
        ...
        out = self.grammar(output + topics_output, hid, grammar)
