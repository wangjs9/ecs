...
class Config(object):
    ...
    def __init__(self, use_words, dataset):
        ...
        self.train_path = dataset + '/data/dataset_classes/train_seg.txt'                                # 训练集
        self.dev_path = dataset + '/data/dataset_classes/dev_seg.txt'                                    # 验证集
        self.test_path = dataset + '/data/dataset_classes/test_seg.txt'                                  # 测试集
